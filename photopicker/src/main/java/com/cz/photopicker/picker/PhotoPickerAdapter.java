...
public class PhotoPickerAdapter extends BaseRecyclerViewAdapter<PickerItemBean> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return viewType == VIEW_TYPE_CAMERA ?
                new PickerCameraViewHolder(getLayoutView(parent, R.layout.item_picker_camera_layout)) :
                new PickerViewHolder(getLayoutView(parent, R.layout.item_picker_layout));
    }
